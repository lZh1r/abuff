...
use crate::{ast::typed::{Expr, Method, Statement, TypeInfo, TypeKind},
...
pub fn substitute_generic_params(
    type_info: &Spanned<TypeInfo>,
    generic_arg_map: &HashMap<SmolStr, 
        Spanned<TypeInfo>>
) -> Spanned<TypeInfo> {
...
pub fn flatten_type<'a>(type_info: &'a Spanned<TypeInfo>, env: &mut TypeEnv) -> Result<Cow<'a, Spanned<TypeInfo>>, Spanned<SmolStr>> {
    match type_info.inner.kind() {
